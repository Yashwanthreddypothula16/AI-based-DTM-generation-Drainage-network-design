...
def main():
    ...
    show(
        ...
        ax=ax1,
        cmap="terrain",
        title="Digital Terrain Model + Connected Drainage Network",
    )
    ...
    if twi:
        ...
        show(
            ...
            ax=ax2,
            cmap="Blues",
            title="Waterlogging Hotspots (Topographic Wetness Index)",
        )
    ...
    output_path = r"C:\Users\nanir\.gemini\antigravity\brain\e25be27b-f581-4821-a67d-2789942db877\results_map.png"
