...
def main():
    ...
    rgb = ls.shade(
        np.flipud(dtm_data), cmap=plt.cm.terrain, vert_exag=3.0, blend_mode="overlay"
    )
    ...
    ax.set_title(
        "Rajasthan Village: Ground-Level Topography Perspective",
        fontsize=20,
        fontweight="bold",
        pad=20,
    )
    ...
    brain_out = r"C:\Users\nanir\.gemini\antigravity\brain\e25be27b-f581-4821-a67d-2789942db877\GROUND_LEVEL_3D_VIEW.png"
