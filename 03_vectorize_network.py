...
def main():
    ...
    wbt.raster_streams_to_vector(
        streams=streams_raster, d8_pntr=flow_dir, output=output_shp
    )

    print(f"Success! Vector drainage network saved as '{output_shp}'")
    print(
        "This file contains fully connected drainage polylines, which satisfy the 'GIS-ready' requirement."
    )
