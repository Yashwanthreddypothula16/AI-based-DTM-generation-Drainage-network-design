...
def main():
    ...
    rgb = ls.shade(
        np.flipud(dtm_data), cmap=plt.cm.terrain, vert_exag=2.0, blend_mode="overlay"
    )
    ...
    ax.set_title(
        "Rajasthan Village: High-Definition 3D Terrain Analysis",
        fontsize=24,
        fontweight="bold",
        pad=30,
    )
    ...
    brain_out = r"C:\Users\nanir\.gemini\antigravity\brain\e25be27b-f581-4821-a67d-2789942db877\ULTRA_HD_3D_TERRAIN.png"
