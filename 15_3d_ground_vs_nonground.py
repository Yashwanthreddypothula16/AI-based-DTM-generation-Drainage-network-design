...
def main():
    ...
    n_sample = 150000
    s_ground = np.random.choice(
        ground_idx, min(len(ground_idx), n_sample), replace=False
    )
    ...
    ax.scatter(
        ...
        s=1.0,
        alpha=0.8,
        label="Class 1: Non-Ground / Buildings / Trees",
        depthshade=False,
    )

    # Formatting
    ax.set_title(
        "AI/ML 3D Output Model: Separate Ground & Non-Ground Analysis",
        color="white",
        fontsize=24,
        fontweight="bold",
        pad=30,
    ...
    brain_out = r"C:\Users\nanir\.gemini\antigravity\brain\e25be27b-f581-4821-a67d-2789942db877\3D_GROUND_VS_NONGROUND.png"
